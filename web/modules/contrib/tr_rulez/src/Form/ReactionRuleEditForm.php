...
use Drupal\rules\Form\RulesComponentFormBase;
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $links['add-event'] = [
      ...
      '#link' => [
        ...
        //'url' => $this->rulesUiHandler->getUrlFromRoute('event.add', ['event' => 'event']),
        'url' => Url::fromRoute(
          'tr_rulez.unimplemented',
          ['feature' => 'Add event', 'title' => 'Multiple Event Triggers', 'issue' => '3010055'],
          ['attributes' => ['class' => ['use-ajax'], 'data-dialog-type' => 'modal']]
        ),
      ],
    ];
